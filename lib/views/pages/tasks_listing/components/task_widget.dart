...
class TaskWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTap: () {
        if (taskData.trash == null ||
            (taskData.trash != null &&
                taskData.trash!.toLowerCase().contains("trash") == false)) {
          onTap(taskData.id);
        }
      },
      child: Stack(
        children: [
          ...
          Visibility(
            visible: taskData.trash != null &&
                taskData.trash!.toLowerCase().contains("trash"),
            child: Positioned(
              top: 0,
              left: 0,
              right: 0,
