...
import '../model/create_edit_employee_assigned_projects_hours/edit_employee_assigned_projects_hours_res_model.dart';
...
class PutRequests {
  ...
  static Future<EditEmployeeAssignedProjectsHoursResModel?>
      editEmployeeAssignedProjectsHours(
          Map<String, dynamic> requestBody, int id) async {
    var apiResponse = await RemoteService.simplePut(
      "${ApiUrls.weeklyHours}/$id/update",
      headers: {
        "Accept": "application/json",
        "Content-Type": "application/json;charset=utf-8"
      },
    ...
    if (apiResponse != null) {
      return editEmployeeAssignedProjectsHoursResModelFromJson(
